...
from src.models.modules.blocks.scse import SCSEModule
...
class DecoderBlock(nn.Module):
    ...
    def __init__(
        ...
        self.attention1 = SCSEModule(channels=in_channels + skip_channels) if use_attention else None
        ...
        self.attention2 = SCSEModule(channels=out_channels) if use_attention else None
