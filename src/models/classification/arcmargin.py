...
from .heads import AbstractHead


@HEADS.register_class
@CLASSIFICATION_HEADS.register_class
class ArcMarginHead(AbstractHead):
    """
    Implement of large arc margin distance:

    :param in_features: size of each input sample
    :param num_classes: size of each output sample
    :param scale: norm of output features
    :param margin: margin for the positive class
    :return: scale * cosine(theta + margin)
    """
