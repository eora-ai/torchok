...
class AnchorGenerator:
    ...
    def valid_flags(self, featmap_sizes, pad_shape, device='cuda'):
        ...
        for i in range(self.num_levels):
            ...
            h, w = pad_shape[:2]
            # TODO: check anchor stride index (h, w or w, h)
            valid_feat_h = min(int(torch.ceil(h / anchor_stride[1])), feat_h)
            valid_feat_w = min(int(torch.ceil(w / anchor_stride[0])), feat_w)
