...
from src.models.layers import DropPath, to_2tuple, trunc_normal_, lecun_normal_
...
class PatchEmbed(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, embed_dim=768, norm_layer=None):
        ...
        self.patch_grid = torch.Size((img_size[0] // patch_size[0], img_size[1] // patch_size[1]))
...
class VisionTransformer(BackboneBase):
    """ Vision Transformer
    ...
    def forward_features(self, x):
        x = self.patch_embed(x).flatten(start_dim=1, end_dim=2)
