...
from src.models.layers import create_conv2d
...
class EfficientNet(BackboneBase):
    ...
    def __init__(self, block_args, num_features=1280, in_chans=3, stem_size=32,
                 ...
                 output_stride=32, pad_type='', fix_stem=False, act_layer=nn.ReLU, drop_path_rate=0.,
        ...
        self.conv_head = create_conv2d(builder.in_chs, self.num_features, 1, padding=pad_type)
...
def efficientnet_el_pruned(pretrained=False, **kwargs):
    ...
    For more info: https://github.com/DeGirum/pruned-models/releases/tag/efficientnet_v1.0
    """
    model = _gen_efficientnet_edge(
