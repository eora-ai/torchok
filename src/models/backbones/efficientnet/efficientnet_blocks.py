...
from src.models.layers import create_conv2d, drop_path, get_act_layer
from src.models.layers.activations import sigmoid
...
class ChannelShuffle(nn.Module):
    ...
    def forward(self, x):
        ...
        x = x.view(N, g, int(C / g), H, W).permute(0, 2, 1, 3, 4)
