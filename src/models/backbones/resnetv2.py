...
from src.models.layers import GroupNormAct, DropPath, AvgPool2dSame, create_pool2d, StdConv2d
...
class ResNetV2(BackboneBase):
    """Implementation of Pre-activation (v2) ResNet mode.
    """

    def __init__(self, layers, channels=(256, 512, 1024, 2048),
                 in_chans=3, output_stride=32, width_factor=1, stem_chs=64,
                 stem_type='', avg_down=False, preact=True, act_layer=nn.ReLU,
                 conv_layer=StdConv2d, norm_layer=partial(GroupNormAct, num_groups=32),
                 drop_path_rate=0., set_neck=False):
        super().__init__()
        wf = width_factor
