...
from src.models.layers import DropPath, AvgPool2dSame, ScaledStdConv2d, ScaledStdConv2dSame, \
...
class NormFreeNet(BackboneBase):
    ...
    def __init__(self, cfg: NfCfg, in_chans=3, output_stride=32, drop_path_rate=0., set_neck=False):
        super().__init__()
