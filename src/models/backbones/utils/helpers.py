...
from src.models.layers import Conv2dSame
from .features import FeatureHooks
from .hub import download_cached_file, load_state_dict_from_url
...
def load_checkpoint(model, checkpoint_path, strict=True, dry_run=False):
