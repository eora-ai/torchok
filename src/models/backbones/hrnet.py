...
def _cfg(url='', **kwargs):
    return {
        ...
        'first_conv': 'conv1', 'classifier': 'classifier', **kwargs
    }
...
class HighResolutionNet(BackboneBase):

    def __init__(self, cfg, in_chans=3, **kwargs):
        ...
        self.stage_names = ['stage2', 'stage3', 'stage4']
        self.encoder_channels = cfg[f'STAGE4']['NUM_CHANNELS']
