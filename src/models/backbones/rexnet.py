...
from src.models.layers import create_act_layer, ConvBnAct, DropPath, make_divisible
from .base import BackboneBase
from .efficientnet.efficientnet_builder import efficientnet_init_weights
...
class ReXNetV1(BackboneBase):
    def __init__(self, in_chans=3, output_stride=32, initial_chs=16, final_chs=180,
                 width_mult=1.0, depth_mult=1.0, se_ratio=1 / 12., ch_div=1, act_layer='swish',
                 dw_act_layer='relu6', drop_path_rate=0., set_neck=False):
