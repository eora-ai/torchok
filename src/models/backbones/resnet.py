...
def create_resnet(pretrained: bool = False, pretrained_url: Optional[str] = None, **kwargs):
    """Create ResNet base model."""
    return build_model_with_cfg(ResNet, pretrained=pretrained, pretrained_url=pretrained_url, **kwargs)


@BACKBONES.register_class
def resnet18(pretrained: bool = False,
             pretrained_url: str = 'https://torchok-hub.s3.eu-west-1.amazonaws.com/resnet18-torchok.pth', **kwargs):
    """It's constructing a ResNet-18 model."""
    model_args = dict(block=BasicBlock, layers=[2, 2, 2, 2], **kwargs)
    return create_resnet(pretrained, pretrained_url, **model_args)


@BACKBONES.register_class
def resnet34(pretrained: bool = False,
             pretrained_url: str = 'https://torchok-hub.s3.eu-west-1.amazonaws.com/resnet34-torchok.pth', **kwargs):
...
def resnet50(pretrained: bool = False,
             pretrained_url: str = 'https://torchok-hub.s3.eu-west-1.amazonaws.com/resnet50-torchok.pth', **kwargs):
...
def resnet101(pretrained: bool = False,
              pretrained_url: str = 'https://torchok-hub.s3.eu-west-1.amazonaws.com/resnet101-torchok.pth', **kwargs):
...
def resnet152(pretrained: bool = False,
              pretrained_url: str = 'https://torchok-hub.s3.eu-west-1.amazonaws.com/resnet152-torchok.pth', **kwargs):
...
@BACKBONES.register_class
def seresnet18(pretrained: bool = False,
               pretrained_url: Optional[str] = None, **kwargs):
...
@BACKBONES.register_class
def seresnet34(pretrained: bool = False,
               pretrained_url: Optional[str] = None, **kwargs):
...
@BACKBONES.register_class
def seresnet50(pretrained: bool = False,
               pretrained_url: str = 'https://torchok-hub.s3.eu-west-1.amazonaws.com/seresnet50-torchok.pth', **kwargs):
...
@BACKBONES.register_class
def seresnet101(pretrained: bool = False,
                pretrained_url: Optional[str] = None, **kwargs):
...
@BACKBONES.register_class
def seresnet152(pretrained: bool = False,
                pretrained_url: Optional[str] = None, **kwargs):
