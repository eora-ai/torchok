...
from src.models.modules.blocks.dropblock import DropBlock2d, DropPath
...
def seresnext26d_32x4d(pretrained=False, **kwargs):
    ...
    model_args = dict(
        block=Bottleneck, layers=[2, 2, 2, 2], cardinality=32, base_width=4, stem_width=32,
        stem_type='deep', avg_down=True, block_args=block_args, **kwargs)
...
def seresnext26t_32x4d(pretrained=False, **kwargs):
    ...
    model_args = dict(
        block=Bottleneck, layers=[2, 2, 2, 2], cardinality=32, base_width=4, stem_width=32,
        stem_type='deep_tiered', avg_down=True, block_args=block_args, **kwargs)
...
def senet154(pretrained=False, **kwargs):
    ...
    model_args = dict(
        ...
        down_kernel_size=3, block_reduce_first=2, block_args=block_args, **kwargs)
