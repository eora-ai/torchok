...
class ConvBnAct(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size=1, stride=1, padding='', dilation=1, groups=1,
                 bias=False, apply_act=True, norm_layer=nn.BatchNorm2d, act_layer=nn.ReLU,
                 inplace=True, aa_layer=None, drop_block=None):
        ...
        self.bn = norm_act_layer(out_channels, apply_act=apply_act, drop_block=drop_block, inplace=inplace)
