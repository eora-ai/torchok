...
def to_tensor(x: Union[torch.Tensor, np.ndarray, list, tuple], dtype: torch.dtype = None) -> torch.Tensor:
    """Create torch tensor from torch.Tensor, np.ndarray, list, tuple types, with specific dtype.
    ...
    Raises:
        ValueError: If x not in torch.Tensor, np.ndarray, list, tuple types.
    """
