...
class TestResNet18(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.__model = BACKBONES.get('resnet18')(pretrained=False, in_chans=3)
        self.__model.load_state_dict(torch.load("/workdir/vpatrushev/torchOK2/torchok/weights/resnet18-torchok.pth"))
...
#     def __init__(self, methodName: str = ...) -> None:
#         super().__init__(methodName)
#         self.__input = torch.ones(1, 1, 224, 224)
#         self.__timm_model = timm.create_model('resnet50', pretrained=True, in_chans=1)
#         self.__output = {}
...
#         self.__model = BACKBONES.get('resnet50')(pretrained=True, in_chans=1)
#         self.assertTrue(self.__model(self.__input).equal(self.__output['output_last_layer']))
...
#         super().__init__(methodName)
#         self.__input = torch.ones(1, 1, 224, 224)
#         self.__timm_model = timm.create_model('seresnet50', pretrained=True, in_chans=1)
#         self.__output = {}
...
#         self.__model = BACKBONES.get('seresnet50')(pretrained=True, in_chans=1)
#         self.assertTrue(self.__model(self.__input).equal(self.__output['output_last_layer']))
