...
class MMResNet(BaseModule):
    ...
    def __init__(self,
        ...
        self.out_encoder_channels = [256, 512, 1024, 2048]
        block_init_cfg = None
        ...
        self.init_weights()
        if init_cfg and 'Pretrained' == init_cfg['type']:
            state_dict = load_state_dict_from_url(init_cfg['checkpoint'])
